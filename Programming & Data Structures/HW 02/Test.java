...
public class Test{
    ...
    public static void sortEvents(Event[] list, int num){
        //INSERTIONS SORT FOR THE MINUTES
        for(int i = 0; i < num; i++){
            if(i < num){
                Event e = list[i];
                int j = i;
                while(j > 0 && (e.getTime().getMinutes() < list[j - 1].getTime().getMinutes())){
                    list[j] = list[j - 1];
                    j--;
                }
                list[j] = e;
        ...
        //INSERTIONS SORT FOR THE HOURS
        for(int i = 0; i < num; i++){
            if(i < num){
                Event e = list[i];
                int j = i;
                while(j > 0 && (e.getTime().getHours() < list[j - 1].getTime().getHours())){
                    list[j] = list[j - 1];
                    j--;
                }
                list[j] = e;
        ...
        //INSERTION SORT FOR THE DAY
        for(int i = 0; i < num; i++){
            if(i < num){
                Event e = list[i];
                int j = i;
                while(j > 0 && (e.getDate().getDay() < list[j - 1].getDate().getDay())){
                    list[j] = list[j - 1];
                    j--;
                }
                list[j] = e;
        ...
        //INSERTION SORT FOR THE MONTH
        for(int i = 0; i < num; i++){
            if(i < num){
                Event e = list[i];
                int j = i;
                while(j > 0 && (e.getDate().getMonth() < list[j - 1].getDate().getMonth())){
                    list[j] = list[j - 1];
                    j--;
                }
                list[j] = e;
        ...
        //INSERTION SORT FOR THE YEAR
        for(int i = 0; i < num; i++){
            if(i < num){
                Event e = list[i];
                int j = i;
                while(j > 0 && (e.getDate().getYear() < list[j - 1].getDate().getYear())){
                    list[j] = list[j - 1];
                    j--;
                }
                list[j] = e;
